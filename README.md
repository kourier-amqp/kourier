...
```kotlin
dependencies {
    implementation("dev.kourier:amqp-client:0.5.0")
}
```
...
```kotlin
dependencies {
    implementation("dev.kourier:amqp-client-robust:0.5.0")
}
```
...
```kotlin
dependencies {
    implementation("dev.kourier:amqp-client-opentelemetry:0.5.0")
